...
function Register() {
  ...
  return (
    <div className="mt-28">
        ...
        <label className="mt-2 text-xl">
            <h2>Nombre</h2>
            <input className="px-2 py-1  border-2 border-solid rounded-lg border-black" name="email" {...register("name", { required: true })}></input>
        </label>
        <label className="mt-2 text-xl">
            <h2>Pregunta de seguridad 1</h2>
            <input className="px-2 py-1  border-2 border-solid rounded-lg border-black" name="email" {...register("question_1", { required: true })}></input>
        </label>
        <label className="mt-2 text-xl">
            <h2>Respuesta 1</h2>
            <input className="px-2 py-1  border-2 border-solid rounded-lg border-black" name="email" {...register("answer_1", { required: true })}></input>
        </label>
        <label className="mt-2 text-xl">
            <h2>Pregunta de seguridad 2</h2>
            <input className="px-2 py-1  border-2 border-solid rounded-lg border-black" name="email" {...register("question_2", { required: true })}></input>
        </label>
        <label className="mt-2 text-xl">
            <h2>Respuesta 2</h2>
            <input className="px-2 py-1  border-2 border-solid rounded-lg border-black" name="email" {...register("answer_2", { required: true })}></input>
        </label>
