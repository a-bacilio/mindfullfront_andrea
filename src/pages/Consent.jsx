...
function Consent() {
  return (
    <><div class="w-full max-w-96 mt-8 mb-8 h-full p-10 overflow-auto bg-purple-800/75 rounded-lg text-white text-justify">
      ...
      Lo estamos invitando a participar en un estudio para determinar si una aplicación nueva de mindfulness puede mejorar los índices de estrés en los estudiantes de pregrado entre el segundo y quinto año, de la Universidad Peruana Cayetano Heredia (UPCH). Este es un estudio desarrollado por investigadores de la Universidad Peruana Cayetano Heredia.
      El estrés puede afectar el bienestar psicológico e interfiere con el aprendizaje y el desempeño clínico. Por este motivo, hay una necesidad clara para que las universidades incluyan el bienestar de los estudiantes en salud mental como un objetivo en el currículo. Actualmente, una de las intervenciones que se utiliza en profesionales de Salud para la reducción de estrés es el uso de entrenamiento en Mindfulness Based Stress Reduction (MBSR). Esto consiste en un entrenamiento de 8 semanas en el que los participantes aprenden a enfocar su atención en el presente a través de ejercicios de meditación. También es posible reducir el estrés a través de otras formas de meditación, realizando ejercicio, haciendo modificaciones en la dieta, manteniendo un fuerte circulo social y durmiendo mejor.
      ...
      Una copia de este consentimiento informado le será entregada vía correo electrónico.

      DECLARACIÓN Y/O CONSENTIMIENTO
      Acepto voluntariamente participar en este estudio, comprendo de las actividades en las que participaré si decido ingresar al estudio, también entiendo que puedo decidir no participar y que puedo retirarme del estudio en cualquier momento.
